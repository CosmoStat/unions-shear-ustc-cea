...
output_path='/data/Qinxun/KiDSdata/Shear_signal/shear_%s_lensfit_testformartin'%(lens_name)
...
end_time=time.time()
dat=open('/data/Qinxun/UNIONS_old_time','w+')
print('Running time:%.2f'%(end_time-start_time),file=dat)
dat.close()
pool.close()
